  ...
  case cboTipo.ItemIndex of
    ...
    1:
      begin
        ...
        RichEdit1.Text:= 'Declaro para os devidos fins de direito que o(a) aluno(a) '+aluno+' nascido(a) em '+dataNasc+', filho(a) de '+pai+' e '+mae+', cursou '+serie+' neste Estabelecimento de Ensino no ano de '+anoLetivo+' , estando APTO a dar continuidade ao curso. Todos os débitos referentes às mensalidades escolares foram quitados.';
