...
if opcTipo.ItemIndex = -1 then
  ...
  begin
    ...
    if opcTipo.ItemIndex = 0 then
      sqlCaixa.SQL.Add('SELECT * FROM caixa WHERE (tipo="C") AND (data BETWEEN #'+IntToStr(dia1)+'/'+IntToStr(mes1)+'/'+IntToStr(ano1)+'# AND #'+IntToStr(dia2)+'/'+IntToStr(mes2)+'/'+IntToStr(ano2)+'#) ORDER BY data DESC, hora DESC');

    if opcTipo.ItemIndex = 1 then
      sqlCaixa.SQL.Add('SELECT * FROM caixa WHERE (tipo="D") AND (data BETWEEN #'+IntToStr(dia1)+'/'+IntToStr(mes1)+'/'+IntToStr(ano1)+'# AND #'+IntToStr(dia2)+'/'+IntToStr(mes2)+'/'+IntToStr(ano2)+'#) ORDER BY data DESC, hora DESC');

    if opcTipo.ItemIndex = 2 then
      sqlCaixa.SQL.Add('SELECT * FROM caixa WHERE (data BETWEEN #'+IntToStr(dia1)+'/'+IntToStr(mes1)+'/'+IntToStr(ano1)+'# AND #'+IntToStr(dia2)+'/'+IntToStr(mes2)+'/'+IntToStr(ano2)+'#) ORDER BY data DESC, hora DESC');
...
begin
  ...
  sqlTotais.Close;
  sqlTotais.SQL.Clear;
  sqlTotais.SQL.Add('SELECT SUM(valor) AS totalEntradas FROM caixa WHERE (tipo="C") AND (data BETWEEN #'+IntToStr(dia1)+'/'+IntToStr(mes1)+'/'+IntToStr(ano1)+'# AND #'+IntToStr(dia2)+'/'+IntToStr(mes2)+'/'+IntToStr(ano2)+'#)');
  sqlTotais.Open;
  ...
  sqlTotais.Close;
  sqlTotais.SQL.Clear;
  sqlTotais.SQL.Add('SELECT SUM(valor) AS totalSaidas FROM caixa WHERE (tipo="D") AND (data BETWEEN #'+IntToStr(dia1)+'/'+IntToStr(mes1)+'/'+IntToStr(ano1)+'# AND #'+IntToStr(dia2)+'/'+IntToStr(mes2)+'/'+IntToStr(ano2)+'#)');
  sqlTotais.Open;
